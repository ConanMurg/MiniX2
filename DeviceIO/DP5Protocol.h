...
enum TRANSMIT_PACKET_TYPE {
    ...
    XMTPT_TEXT_CONFIGURATION,                // sends configuration commands without any changes
    XMTPT_TEXT_CONFIGURATION_MX2,            // Mini-X2 configuration commands
    XMTPT_TEXT_CONFIGURATION_FILTERED,       // runs filters/fixes then sends configuration commands
    XMTPT_READ_TEXT_CONFIGURATION,           // requests cfg for cmd string provided without any changes
    XMTPT_READ_TEXT_CONFIGURATION_MX2,       // Mini-X2 configuration request
    XMTPT_FULL_READ_TEXT_CONFIGURATION,      // Requests all configuration parameters
    XMTPT_SHORT_READ_TEXT_CONFIGURATION,     // Request subset of configuration parameters for status 
    ...
    //REQUEST_PACKETS_TO_MX2
    XMTPT_SEND_TUBE_ILOCK_TABLE_MX2,
    XMTPT_SEND_WARMUP_TABLE_MX2,
    XMTPT_SEND_TIMESTAMP_RECORD_MX2,
    XMTPT_SEND_FAULT_RECORD_MX2,

    //REQUEST_PACKETS_TO_MX2 with simple data
    XMTPT_WRITE_TIMESTAMP_MX2,
    XMTPT_INITIATE_WARMUP_DAILY_SEQUENCE_MX2,
    XMTPT_INITIATE_WARMUP_MONTHLY_SEQUENCE_MX2,

    //REQUEST_PACKETS_TO_MX2 by Firmware Manager
    XMTPT_WRITE_TUBE_ILOCK_TABLE_MX2,
    XMTPT_WRITE_WARMUP_SEQUENCE_MX2,
    XMTPT_KEEP_ALIVE_SHARING,
    XMTPT_KEEP_ALIVE_NO_SHARING,
    XMTPT_KEEP_ALIVE_LOCK
...
enum PID2_REQ_STATUS_TYPE {
    ...
    PID2_SEND_DP4_STYLE_STATUS_MX2 = 0x02
...
enum PID2_REQ_SCOPE_MISC_TYPE {
    ...
    //--------------------------------------------------------------
    PID2_SEND_MX2_TUBE_ILOCK_TABLE = 0x0B,    //Mini-X2 Only Functions
    PID2_SEND_MX2_WARMUP_TABLE = 0x0C,
    PID2_SEND_MX2_TIMESTAMP_RECORD = 0x0D,
    PID2_SEND_MX2_FAULT_RECORD = 0x0E
...
enum PID2_VENDOR_REQ_TYPE {
    ...
    PID2_INIT_MX2_WARMUP_SEQUENCE = 0x33
...
enum PID2_RCV_SCOPE_MISC_TYPE {
    ...
    RCVPT_MX2_TUBE_ILOCK_TABLE = 0x0D,
    RCVPT_MX2_WARMUP_TABLE = 0x0E,
    RCVPT_MX2_TIMESTAMP_RECORD = 0x0F,
    RCVPT_MX2_FAULT_RECORD = 0x10
};  //PID2_REQ_SCOPE_MISC_TYPE
